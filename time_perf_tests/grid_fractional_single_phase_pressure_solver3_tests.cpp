...
#include "../src.common/face_centered_grid3.h"
...
using vox::kMaxD;
using vox::Vector3D;
using vox::FaceCenteredGrid3;
using vox::CellCenteredScalarGrid3;
using vox::ConstantScalarField3;
using vox::ConstantVectorField3;
...
public:
    ...
    vox::GridFractionalSinglePhasePressureSolver3 solver;
